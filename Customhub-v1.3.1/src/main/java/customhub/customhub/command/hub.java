                ...
                new BukkitRunnable() {
                    ...
                    public void run() {
                        if (sec >= 0) {
                            ...
                            String subtitle = plugin.getConfig().getString("messege-subtitle");
                            if(plugin.getConfig().getBoolean("messege-title-switch"))
                            {
                                if (plugin.getConfig().getBoolean("messege-subtitle-switch"))
                                {
                                    player.sendTitle(title + sec, subtitle + sec);
                                }
                                else
                                {
                                    player.sendTitle(title + sec, " ");
                                }
                            }
                            else
                            {
